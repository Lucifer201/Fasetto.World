...
namespace Fasetto.World.Core
{
    ...
    public class ChatMessageListItemViewModel:BaseViewModel
    {
        ...
        /// <summary>
        /// True if this message was sent by the sighed in user
        /// </summary>
        public bool SentByMe { get; set; }

        /// <summary>
        /// The time the message was road, or <see cref="DateTimeOffset.MinValue"/> if not read
        /// </summary>
        ...
        /// <summary>
        /// A flag indicating if this item is added since the first main list of items was created
