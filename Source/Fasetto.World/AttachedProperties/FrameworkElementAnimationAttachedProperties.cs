...
namespace Fasetto.World
{
                ...
                onLoaded = async (ss, ee) =>
                  {
                      ...
                      //Slight delay after load is needed for some elements to laid out
    ...
    /// <summary>
    /// Animates a frame element sliding up from the left on show
    /// and siding out to the left on hide
    /// </summary>
    ...
    /// <summary>
    /// Animates a frame element sliding up from the bottom on show
    /// and sliding ou to the bottom on hide
    /// </summary>
    ...
    /// <summary>
    /// Animates a frame element sliding up from the bottom on load
    /// and sliding ou to the bottom on hide
    /// </summary>
    ...
    /// <summary>
    /// Animates a frame element fades in/out
    /// </summary>
    ...
    public class AnimateMarqueeProperty : AnimateBaseProperty<AnimateMarqueeProperty>
    {
        ...
        {
            //Animate in
            element.MarqueeAsync(firstLoad ? 0 : 0.3f);
        }
    }
