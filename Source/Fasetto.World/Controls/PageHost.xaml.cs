...
namespace Fasetto.World
{
    ...
    public partial class PageHost : UserControl
    {
        ...
        private static object CurrentPagePropertyChanged(DependencyObject d, object value)
        {
            ...
            //If the current page dosen't changed
            //just upadate the view model
            ...
            //Store the curren page content as the old page
            ...
            //Animate out previos page when the Loaded event fires
            //right after this call due to moving frames
            if (oldPageContent is BasePage oldPage)
            {
                //Tell the page animate out
